...
---
title: "Análisis de Grupos y Regresión Ridge para Datos de Vivienda"
output: html_document
---
...
```{r analisis_caracteristicas_clusters}
...
```{r visualizar_precios_por_cluster, fig.width=8, fig.height=6}
...
```{r visualizar_caracteristicas_por_cluster, fig.width=10, fig.height=6}
